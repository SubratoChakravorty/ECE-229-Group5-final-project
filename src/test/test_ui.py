...
def test_ui008_sunburst_plot_gives_select_score_prompt(dash_duo):
    ...
    dash_duo.wait_for_contains_text('#sunburst_plot', "Select a score", timeout=3)
...
def test_ui009_second_univariate_plot_box_gives_select_score_prompt(dash_duo):
    ...
    dash_duo.wait_for_contains_text('#second_explore_plot', "select a score", timeout=3)
...
def test_ui003_second_univariate_plot_box(dash_duo):
    ...
    dash_duo.wait_for_contains_text('#second_explore_plot', short_text, timeout=3)
...
def test_ui007_toggle_modal(dash_duo):
    ...
    dash_duo.wait_for_element("#close-xl", timeout=1)
    dash_duo.multiple_click("#close-xl", clicks=1)


    dash_duo.wait_for_element("#save-xl", timeout=1)
